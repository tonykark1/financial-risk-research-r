...
> **Historical snapshot — superseded.** This README preserves the pre-September-2026 release, including the original glmnet tuning error and its old rankings. Use the [current macro-only README](../../README.md) for corrected results.
...
**[Open the historical 30-plot research gallery](../supporting-case-studies/reports/plot_gallery.html)** — ten macro-forecasting, ten bank-risk, and ten company-fundamentals views, with an auditable [plot manifest](../supporting-case-studies/reports/plot_gallery_manifest.csv). Its macro panels are retained as superseded pre-correction artifacts.

The archived pre-correction experiment produced **127,218 chronological out-of-sample forecasts** across 28 model–horizon combinations and reported HAR-VIX as the lowest-QLIKE model at every horizon. That ranking is superseded: the corrected release finds Elastic Net first at 1 and 5 days, and HAR-VIX first at 10 and 22 days.
...
![Macro report with true-vintage coverage manifest](docs/macro-model-comparison.png)
...
![Duration-aware fundamentals report](../supporting-case-studies/docs/fundamentals-quality.png)
